...
================================================================
	* All the core foundation food tables are created
...
-- food
CREATE TABLE IF NOT EXISTS stg.food_ff (
...
-- foundation food
CREATE TABLE IF NOT EXISTS stg.foundation_food (
    fdc_id INT PRIMARY KEY,
    NDB_number INT,
    footnote TEXT,

	CONSTRAINT fk_foundation_food
		FOREIGN KEY (fdc_id)
		REFERENCES stg.food_ff(fdc_id)
);

-- food nutrient
CREATE TABLE IF NOT EXISTS stg.food_nutrient_ff (
    id INT PRIMARY KEY,
    fdc_id INT,
    nutrient_id INT,
    amount NUMERIC(8,2),
